<div class="mx-auto max-w-3xl space-y-6">
    <div>
        ...
        <h1 class="mt-4 text-2xl font-bold text-fleet-ink">{{ __('Editar veículo') }}</h1>
        <p class="mt-1 text-sm text-fleet-secondary">{{ __('Placa') }}: <span class="font-medium text-fleet-ink">{{ $vehicle->plate }}</span></p>
    </div>
